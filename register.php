...
<form action="reg.php" style="border:1px solid #ccc">
  <div class="container">
    ...
    <input type="text" placeholder="Enter contact" name="c" required>
	
	<label><b>Pincode</b></label>
    <input type="text" placeholder="Enter pincode" name="p1" required>

...
<?php echo"Welcome:".$_SESSION["user"]; ?>    <section class="welcome-area section-padding2">
...
<tr>
<td>
<img src='upload/<?php echo$row[3];?>'width='220px' height='150px'>
<a href="order.php?order=<?php echo$row[0];?>">
<input type="button" value="BUY" style="width:200">
</a>

<img src='upload/<?php echo$row1[3];?>'width='220px' height='150px'>
<a href="order.php?order=<?php echo$row1[0];?>">
<input type="button" value="BUY" style="width:200">
</a>
</td>
</tr>
            ...
            <div class="row">
                <div class="col-lg-5 col-md-6 align-self-center">
                    ...
                    <div class="deshes-text">
                        ...
                        <a href="order.php" class="template-btn mt-3">Buy</a>
                    </div>
                </div>

                ...
                <div class="col-lg-10">
                    ...
                    <div class="main-menu">
                        <ul>
							...
							<li><a href="#">Login</a>
							<ul class="sub-menu">
                                    <li><a href="customerpage.html">Login</a></li>
...
{
	echo"<img src='upload/$row[3]' class='img-fluid' alt=''>";
                        ...
                        <div class="food-content">
                            <div class="d-flex justify-content-between">
                                ...
                                <span class="style-change">Rs.250</span>
                            </div>
                            <p class="pt-3">Face together given moveth divided form Of Seasons that fruitful.</p>
							<a href="order.php?order=<?php echo$row[0];?>" class="template-btn mt-3">Buy</a>
...
?>    
                        ...
                        <div class="food-content">
                            <div class="d-flex justify-content-between">
                                ...
                                <span class="style-change">Rs.185</span>
                            </div>
                            <p class="pt-3">Face together given moveth divided form Of Seasons that fruitful.</p>
							<a href="order.php?order=<?php echo$row[0];?>" class="template-btn mt-3">Buy</a>
							<?php
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-food mt-5 mt-md-0">
                        ...
                        <div class="food-content">
                            <div class="d-flex justify-content-between">
                                <h5>topu lasange</h5>
                                <span class="style-change">Rs.220</span>
                            </div>
                            <p class="pt-3">Face together given moveth divided form Of Seasons that fruitful.</p>
                        </div>
                    </div>
                    ...
                    <div class="single-food mt-5">
                        ...
                        <div class="food-content">
                            <div class="d-flex justify-content-between">
                                ...
                                <span class="style-change">Rs.275</span>
                            </div>
                            <p class="pt-3">Face together given moveth divided form Of Seasons that fruitful.</p>
                        </div>
                    </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-food mt-5">
                        ...
                        <div class="food-content">
                            <div class="d-flex justify-content-between">
                                <h5>bean salad</h5>
                                <span class="style-change">Rs.165</span>
                            </div>
                            <p class="pt-3">Face together given moveth divided form Of Seasons that fruitful.</p>
                        </div>
                    </div>
                    ...
                    <div class="single-food mt-5">
                        ...
                        <div class="food-content">
                            <div class="d-flex justify-content-between">
                                ...
                                <span class="style-change">Rs.300</span>
                            </div>
                            <p class="pt-3">Face together given moveth divided form Of Seasons that fruitful.</p>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-5 col-md-6 align-self-center">
                    ...
                    <div class="deshes-text">
                        ...
                        <span class="style-change">Rs.350</span>
            ...
            <div class="row mt-5">
                ...
                <div class="col-lg-5 offset-lg-2 col-md-6 align-self-center order-1 order-md-2">
                    ...
                    <div class="deshes-text">
                        ...
                        <p class="pt-3">Be. Seed saying our signs beginning face give spirit own beast darkness morning moveth green multiply she'd kind saying one shall, two which darkness have day image god their night. his subdue so you rule can.</p>
                        <span class="style-change">Rs.450</span>
